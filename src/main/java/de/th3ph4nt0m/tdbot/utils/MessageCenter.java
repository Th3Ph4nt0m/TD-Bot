...
public class MessageCenter {
  ...
  public void printRulesAndPrivacy(String channelID) {
    ...
    builder
        .setDescription(
            "To use the services of the TD-Nation Discord server, you need to accept the rules and agree with our privacy policy.\n"
                + "\n"
    ...
    channel
        ...
        .queue(message -> message.editMessage(builder.build()).queue());
  }
  ...
  public void printVersion(String pChannelID) {
    ...
    builder.setDescription(
        "My current version is ``" + Bot.getInstance().getGhLoader().getLatestTagName() + "``.");
    assert channel != null;
    channel.sendMessage(builder.build()).queue();
  }
